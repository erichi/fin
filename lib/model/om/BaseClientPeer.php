...
abstract class BaseClientPeer {
	...
	{
		// invalidate objects in ContactPersonPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related ContactPerson objects
			$criteria = new Criteria(ContactPersonPeer::DATABASE_NAME);
			
			$criteria->add(ContactPersonPeer::CLIENT_ID, $obj->getId());
			$affectedRows += ContactPersonPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
