...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'job_order_manager_list'        => new sfWidgetFormPropelChoice(array('model' => 'JobOrder', 'add_empty' => true)),
    ));
    ...
    $this->setValidators(array(
      ...
      'job_order_manager_list'        => new sfValidatorPropelChoice(array('model' => 'JobOrder', 'required' => false)),
    ));
  ...
  public function addJobOrderManagerListColumnCriteria(Criteria $criteria, $field, $values)
  {
    ...
    $criteria->addJoin(JobOrderManagerPeer::USER_ID, sfGuardUserPeer::ID);

    $value = array_pop($values);
    $criterion = $criteria->getNewCriterion(JobOrderManagerPeer::JOB_ORDER_ID, $value);

    foreach ($values as $value)
    {
      $criterion->addOr($criteria->getNewCriterion(JobOrderManagerPeer::JOB_ORDER_ID, $value));
    }
